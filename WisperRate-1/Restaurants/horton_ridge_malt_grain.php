...
<?php
  ...
  if ($sortOption == 'Rating') {
    // Sort by Rating 
    $sql_statement = "SELECT pseudoname, review, rating FROM horton_ridge_malt_grain_reviews ORDER BY CAST(SUBSTRING_INDEX(rating, ' ', 1) AS DECIMAL) DESC";
  } else {
    // Sort by Recent 
    $sql_statement = "SELECT pseudoname, review, rating FROM horton_ridge_malt_grain_reviews ORDER BY added DESC";
  }
...
//format data for database submission
    ...
    if (empty($reviewerName) || empty($reviewerEmail) || empty($reviewText) || empty($rating)) {
        ...
        if (!in_array($rating, $valid_ratings)) {
            ...
            $sql_statement = "INSERT INTO horton_ridge_malt_grain_reviews (pseudoname, email, review, rating) 
...
<html>
  ...
  <body class="d-flex flex-column min-vh-100">
    ...
    <!-- Main Title -->
    <h3 style="text-align: center;">Horton Ridge Malt &Grain</h3> 
    ...
    <section class="container my-4">
      ...
      <div class="scroll-container">
        <div class="card mx-2" style="min-width: 300px;">
            <div class="card-body">
              <h5 class="card-title">Brett Binns</h5>
        ...
        <div class="card mx-2" style="min-width: 300px;">
            <div class="card-body">
              <h5 class="card-title">Shannon Rolanty</h5>
              <p class="card-text">"worth the visit. I’d definitely come back!"</p>
              <p class="card-text"><small>Rating: 4 ★</small></p>
            </div>
        </div>
        <div class="card mx-2" style="min-width: 300px;">
            <div class="card-body">
              <h5 class="card-title">Matthew Wastra</h5>
              <p class="card-text">"Best Beer I had all drip"</p>
